...
#define	SYMLEN	16	/*  Length of labels (must be an even number). 16 = 15 chars, matches REL MAXSYM=15 (was 12) */
...
int errcode; /*  Error records.				*/
int errcount;
int evalerr; /*  Flag to tell of error in eval.		*/
unsigned backflg, oldattr; /*  Item push-back buffer.			*/
unsigned oldvalu;
int curdrive; /*  Place to save drive that was current
 disk when assembly started.		*/
int hexflg; /*  Flag for asmline to tell hex
 generator what to do.			*/
int directok; /*  All symbols on line pre-defined.		*/
