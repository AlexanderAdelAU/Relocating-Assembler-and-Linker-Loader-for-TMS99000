...
/* current string */
#define MAXFILES 20
#define MAXMEM 64000		/* 49kBytes max memory */
...
#define AUXBUF   4096			/* aux buffer for reference file */
#define RELMEM   (1000*CRELSIZE)	/* use for rel table 1000 entries 5 bytes each */
#define MAXOPEN     6			/* maximum files opened */
#define OHDOPEN   512			/* memory overhead per open file */
